...
local function m7(C)
	...
	local mg = l(function()
		return kB:GetTextSize(d3 .. " ", 16, "GothamBold", Vector2.new()).X
	end, { d3 })
	dh(function()
		m3(mf())
	end, 1000)
	return b.createFragment({
		b.createElement(
			"TextLabel",
			{
				Text = d3,
				...
				TextTransparency = aO(lt and 0 or 1, { frequency = 2 }),
				TextXAlignment = "Left",
				TextYAlignment = "Top",
				Position = aO(lt and ar(24, ct) or ar(0, ct), {}),
		...
		b.createElement(
			"TextLabel",
			{
				...
				TextSize = 16,
				TextColor3 = aW.foreground,
				TextTransparency = aO(lt and 0.4 or 1, {}),
				TextXAlignment = "Left",
				TextYAlignment = "Top",
				Position = aO(lt and ar(24 + mg, ct) or ar(0 + mg, ct), {}),
				BackgroundTransparency = 1,
			}
		),
	})
