...
local ar = aq.px
local r = aq.scale
local mk = a.import(script, script.Parent, "ConfigItem")
local ml = mk.default
local lc = mk.ENTRY_HEIGHT
local lb = mk.PADDING
local mm = 1
local function mn()
	local aW = ei("options").config
	return b.createElement(
		c1,
		{ index = 0, page = an.Options, theme = aW, size = ar(326, 184), position = UDim2.new(0, 0, 1, -416 - 48) },
		{
			b.createElement(
				"TextLabel",
				{
