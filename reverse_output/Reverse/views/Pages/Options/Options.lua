...
local mn = a.import(script, script.Parent, "Config").default
local mq = a.import(script, script.Parent, "Shortcuts").default
local mr = a.import(script, script.Parent, "Themes").default
local function ms()
	local ck = cd()
	return b.createElement(
		bl,
		{ position = r(0, 1), anchor = Vector2.new(0, 1) },
		{ b.createElement("UIScale", { Scale = ck }), b.createElement(mn), b.createElement(mr), b.createElement(mq) }
	)
end
local f = l5(ms)
return { default = f }
