...
spawn(function()
    ...
    local TotallyNotSelectionChanged = ExplorerPanel:WaitForChild(
                                           "TotallyNotSelectionChanged")
    local TotallyNotGetSelection = ExplorerPanel:WaitForChild(
                                       "TotallyNotGetSelection")
    local TotallyNotSetSelection = ExplorerPanel:WaitForChild(
                                       "TotallyNotSetSelection")
    ...
    function switchWindows(wName, over)
        ...
        for i, v in pairs(Windows) do
            ...
            if i ~= wName then
                for _, c in pairs(v) do
                    c:TweenPosition(UDim2.new(1, 30, count * 0.5, count * 36),
                                    "Out", "Quad", 0.5, true)
                    count = count + 1
                end
            end
        ...
        if Windows[wName] then
            for _, c in pairs(Windows[wName]) do
                c:TweenPosition(UDim2.new(1, -300, count * 0.5, count * 36),
                                "Out", "Quad", 0.5, true)
                count = count + 1
            end
        end
    ...
    function toggleDex(on)
        if on then
            SideMenu:TweenPosition(UDim2.new(1, -330, 0, 0), "Out", "Quad", 0.5,
                                   true)
            OpenToggleButton:TweenPosition(UDim2.new(1, 0, 0, 0), "Out", "Quad",
                                           0.5, true)
            switchWindows(CurrentWindow, true)
        else
            SideMenu:TweenPosition(UDim2.new(1, 0, 0, 0), "Out", "Quad", 0.5,
                                   true)
            OpenToggleButton:TweenPosition(UDim2.new(1, -30, 0, 0), "Out",
                                           "Quad", 0.5, true)
    ...
    OpenToggleButton.MouseButton1Up:connect(function() toggleDex(true) end)

    OpenScriptEditorButton.MouseButton1Up:connect(function()
        if OpenScriptEditorButton.Active then ScriptEditor.Visible = true end
    end)

    CloseToggleButton.MouseButton1Up:connect(function()
        if CloseToggleButton.Active then toggleDex(false) end
    end)

    for i, v in pairs(SlideFrame:GetChildren()) do
        v.MouseButton1Click:connect(function() switchWindows(v.Name) end)

        v.MouseEnter:connect(function() v.BackgroundTransparency = 0.5 end)
        v.MouseLeave:connect(function()
            if CurrentWindow ~= v.Name then
                v.BackgroundTransparency = 1
            end
        end)
    end
    ...
    function createSetting(name, interName, defaultOn)
        ...
        newSetting.Position =
            UDim2.new(0, 0, 0, #SettingList:GetChildren() * 60)
        ...
        local function toggle(on)
            if on then
                newSetting.Change.Bar:TweenPosition(UDim2.new(0, 32, 0, -2),
                                                    ...
                                                    0.25, true)
                newSetting.Change.OnBar:TweenSize(UDim2.new(0, 34, 0, 15),
                                                  Enum.EasingDirection.Out,
                                                  Enum.EasingStyle.Quart, 0.25,
                                                  true)
                ...
                newSetting.Change.Bar:TweenPosition(UDim2.new(0, -2, 0, -2),
                                                    ...
                                                    Enum.EasingStyle.Quart,
                                                    0.25, true)
                newSetting.Change.OnBar:TweenSize(UDim2.new(0, 0, 0, 15),
                                                  Enum.EasingDirection.Out,
                                                  Enum.EasingStyle.Quart, 0.25,
                                                  true)
        ...
        if defaultOn then toggle(true) end
    end
    ...
    Mouse.Button1Down:connect(function()
        if CurrentWindow == "Explorer" and Settings.ClickSelect then
            ...
            if target then SetSelection:Invoke({target}) end
        end
    end)
    ...
    TotallyNotSelectionChanged.Event:connect(function()
        if Settings.SelBox then
            ...
            if err then SelectionBox.Adornee = nil end
        end
    end)
    ...
    function createMapSetting(obj, interName, defaultOn)
        local function toggle(on)
            if on then
                obj.Change.Bar:TweenPosition(UDim2.new(0, 32, 0, -2),
                                             Enum.EasingDirection.Out,
                                             Enum.EasingStyle.Quart, 0.25, true)
                obj.Change.OnBar:TweenSize(UDim2.new(0, 34, 0, 15),
                                           Enum.EasingDirection.Out,
                                           Enum.EasingStyle.Quart, 0.25, true)
                obj.Status.Text = "On"
                SaveMapSettings[interName] = true
            else
                obj.Change.Bar:TweenPosition(UDim2.new(0, -2, 0, -2),
                                             Enum.EasingDirection.Out,
                                             Enum.EasingStyle.Quart, 0.25, true)
                obj.Change.OnBar:TweenSize(UDim2.new(0, 0, 0, 15),
                                           Enum.EasingDirection.Out,
                                           Enum.EasingStyle.Quart, 0.25, true)
                obj.Status.Text = "Off"
    ...
    function createCopyWhatSetting(serv)
        if SaveMapSettings.CopyWhat[serv] then
            ...
            newSetting.Position = UDim2.new(0, 0, 0,
                                            #SaveMapCopyList:GetChildren() * 22 +
                                                5)
    ...
    createMapSetting(SaveMapSettingFrame.CameraInstances, "CameraInstances",
                     true)
    ...
    SaveMapButton.MouseButton1Click:connect(function()
        ...
        for i, v in pairs(SaveMapSettings.CopyWhat) do
            if v then table.insert(copyWhat, i) end
        end
                ...
                pcall(function()
                    if v:IsA("LocalScript") then
                        ...
                        if v.Source == "" then
                            if consoleFunc then
                                consoleFunc(
                                    "LocalScript " .. v.Name ..
                                        " had a problem decompiling.")
                            end
                        else
                            if consoleFunc then
                                consoleFunc(
                                    "LocalScript " .. v.Name .. " decompiled.")
                            end
                        end
                    elseif v:IsA("ModuleScript") then
                        ...
                        if v.Source == "" then
                            ...
                            if consoleFunc then
                                consoleFunc(
                                    "ModuleScript " .. v.Name .. " decompiled.")
                            end
                        end
                    end
                end)
        ...
        if decompile and copyScripts then decompileS(copyGroup) end

        if SaveInstance then
            SaveInstance(copyGroup, SaveMapName.Text .. ".rbxm")
        elseif saveinstance then
            saveinstance(getelysianpath() .. SaveMapName.Text .. ".rbxm",
                         copyGroup)
        end
        -- print("Saved!")
        if consoleFunc then consoleFunc("The map has been copied.") end
    ...
    IntroFrame:TweenPosition(UDim2.new(1, -300, 0, 0), Enum.EasingDirection.Out,
    ...
    SlideFrame:TweenPosition(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out,
                             Enum.EasingStyle.Quart, 0.5, true)
    OpenScriptEditorButton:TweenPosition(UDim2.new(0, 0, 0, 180),
                                         Enum.EasingDirection.Out,
                                         Enum.EasingStyle.Quart, 0.5, true)
    CloseToggleButton:TweenPosition(UDim2.new(0, 0, 0, 210),
                                    Enum.EasingDirection.Out,
                                    Enum.EasingStyle.Quart, 0.5, true)
    Slant:TweenPosition(UDim2.new(0, 0, 0, 240), Enum.EasingDirection.Out,
                        Enum.EasingStyle.Quart, 0.5, true)
...
- Drag objects to reparent
    ...
    do
        ...
        local n = math.huge
        for i = 1, #size do
            if size[i] <= GUI_SIZE then FONT_SIZE = i - 1 end
        end
    end
    ...
    function createDDown(dBut, callback, ...)
        if barActive then
            for i, v in pairs(activeOptions) do v:Destroy() end
            activeOptions = {}
            barActive = false
            return
        else
        ...
        for i, v in pairs(slots) do
            ...
            newOption.Position = UDim2.new(-0.4, dBut.Position.X.Offset,
                                           dBut.Position.Y.Scale, dBut.Position
                                               .Y.Offset +
                                               (#activeOptions *
                                                   dBut.Size.Y.Offset))
    ...
    do
        ...
        function SetZIndex(object, z)
            if not ZIndexLock[object] then
                ...
                if object:IsA 'GuiObject' then object.ZIndex = z end
                local children = object:GetChildren()
                for i = 1, #children do SetZIndex(children[i], z) end
    ...
    do
        ...
        do
            ...
            local f = math.floor
            function iconDehash(h) return f(h / 14 % 14), f(h % 14) end
        end
            ...
            if not IconFrame then
                IconFrame = Create(class, {
                    ...
                    Create('ImageLabel', {
                        ...
                        BackgroundTransparency = 1,
                        Image = iconMap,
                        Size = UDim2.new(mapSize.x / iconSize, 0,
                                         mapSize.y / iconSize, 0)
                    })
                })
            end

            IconFrame.IconMap.Position = UDim2.new(-col -
                                                       (pad * (col + 1) + border) /
                                                       iconSize, 0, -row -
                                                       (pad * (row + 1) + border) /
                                                       iconSize, 0)
    ...
    do
        ...
        local function ArrowGraphic(size, dir, scaled, template)
            ...
            elseif dir == 'Left' then
                function transform(p, s)
                    return UDim2.new(0, p.Y.Offset, 0, p.X.Offset),
                           UDim2.new(0, s.Y.Offset, 0, s.X.Offset)
                end
            elseif dir == 'Right' then
                function transform(p, s)
                    return UDim2.new(0, size - p.Y.Offset - 1, 0, p.X.Offset),
                           UDim2.new(0, s.Y.Offset, 0, s.X.Offset)
                end
            end
            ...
            if scaled then
                function scale(p, s)
                    return
                        UDim2.new(p.X.Offset / size, 0, p.Y.Offset / size, 0),
            ...
            if size % 2 == 0 then
                ...
                for i = 0, n do
                    ...
                    local p, s = scale(transform(UDim2.new(0, n - i, 0, o + i),
            ...
            if size % 4 > 1 then
                local t = template:Clone()
                local p, s = scale(transform(UDim2.new(0, 0, 0, size - o - 1),
        ...
        local function GripGraphic(size, dir, spacing, scaled, template)
            ...
            if scaled then
                function scale(p)
                    return UDim2.new(p.X.Offset / size.x, 0,
                                     p.Y.Offset / size.y, 0)
                end
            else
        ...
        local mt = {
            __index = {
                ...
                CanScrollDown = function(self)
                    return self.ScrollIndex + self.VisibleSpace <
                               self.TotalSpace
                end,
        ...
        function ScrollBar(horizontal)
            ...
            local ScrollFrame = Create('Frame', {
                Name = "ScrollFrame",
                Position = horizontal and UDim2.new(0, 0, 1, -GUI_SIZE) or
                    UDim2.new(1, -GUI_SIZE, 0, 0),
                Size = horizontal and UDim2.new(1, 0, 0, GUI_SIZE) or
                    UDim2.new(0, GUI_SIZE, 1, 0),
                BackgroundTransparency = 1,
                Create('ImageButton', {
                    Name = "ScrollDown",
                    Position = horizontal and UDim2.new(1, -GUI_SIZE, 0, 0) or
                        UDim2.new(0, 0, 1, -GUI_SIZE),
                ...
                Create('ImageButton', {
                    Name = "ScrollBar",
                    Size = horizontal and UDim2.new(1, -GUI_SIZE * 2, 1, 0) or
                        UDim2.new(1, 0, 1, -GUI_SIZE * 2),
                    Position = horizontal and UDim2.new(0, GUI_SIZE, 0, 0) or
                        UDim2.new(0, 0, 0, GUI_SIZE),
            ...
            local ScrollDownGraphic = ArrowGraphic(graphicSize, horizontal and
                                                       'Right' or 'Down', true,
                                                   graphicTemplate)
            ScrollDownGraphic.Position =
                UDim2.new(0.5, -graphicSize / 2, 0.5, -graphicSize / 2)
            ScrollDownGraphic.Parent = ScrollDownFrame
            local ScrollUpFrame = ScrollFrame.ScrollUp
            local ScrollUpGraphic = ArrowGraphic(graphicSize,
                                                 horizontal and 'Left' or 'Up',
                                                 true, graphicTemplate)
            ScrollUpGraphic.Position = UDim2.new(0.5, -graphicSize / 2, 0.5,
                                                 -graphicSize / 2)
            ...
            do
                ...
                local Decal = GripGraphic(Vector2.new(size, size),
                                          horizontal and 'Vertical' or
                                              'Horizontal', 2, graphicTemplate)
            ...
            if horizontal then
                function UpdateScrollThumb()
                    ScrollThumbFrame.Size = UDim2.new(
                                                Class.VisibleSpace /
                                                    Class.TotalSpace, 0, 0,
                                                GUI_SIZE)
                    if ScrollThumbFrame.AbsoluteSize.x < GUI_SIZE then
                        ScrollThumbFrame.Size =
                            UDim2.new(0, GUI_SIZE, 0, GUI_SIZE)
                    end
                    local barSize = ScrollBarFrame.AbsoluteSize.x
                    ScrollThumbFrame.Position = UDim2.new(
                                                    Class:GetScrollPercent() *
                                                        (barSize -
                                                            ScrollThumbFrame.AbsoluteSize
                                                                .x) / barSize,
                                                    0, 0, 0)
                end
            else
                function UpdateScrollThumb()
                    ScrollThumbFrame.Size =
                        UDim2.new(0, GUI_SIZE,
                                  Class.VisibleSpace / Class.TotalSpace, 0)
                    if ScrollThumbFrame.AbsoluteSize.y < GUI_SIZE then
                        ScrollThumbFrame.Size =
                            UDim2.new(0, GUI_SIZE, 0, GUI_SIZE)
                    end
                    local barSize = ScrollBarFrame.AbsoluteSize.y
                    ScrollThumbFrame.Position = UDim2.new(0, 0,
                                                          Class:GetScrollPercent() *
                                                              (barSize -
                                                                  ScrollThumbFrame.AbsoluteSize
                                                                      .y) /
            ...
            if horizontal then
                ScrollBarFrame.MouseButton1Down:connect(function(x, y)
                    ...
                    if x > ScrollThumbFrame.AbsolutePosition.x then
                        ...
                        wait(0.2)
                        while scrollEventID == current do
                            if x < ScrollThumbFrame.AbsolutePosition.x +
                                ScrollThumbFrame.AbsoluteSize.x then
                                break
                            end
                ...
                ScrollBarFrame.MouseButton1Down:connect(function(x, y)
                    ...
                    if y > ScrollThumbFrame.AbsolutePosition.y then
                        ...
                        wait(0.2)
                        while scrollEventID == current do
                            if y < ScrollThumbFrame.AbsolutePosition.y +
                                ScrollThumbFrame.AbsoluteSize.y then
                                break
                            end
                            Class:ScrollTo(Class.ScrollIndex +
                                               Class.VisibleSpace)
            ...
            if horizontal then
                ScrollThumbFrame.MouseButton1Down:connect(function(x, y)
                    ...
                    drag_con = MouseDrag.MouseMoved:connect(function(x, y)
                        ...
                        local bar_drag =
                            ScrollBarFrame.AbsoluteSize.x -
                                ScrollThumbFrame.AbsoluteSize.x
                        local bar_abs_one = bar_abs_pos + bar_drag
                        x = x - mouse_offset
                        x =
                            x < bar_abs_pos and bar_abs_pos or x > bar_abs_one and
                                bar_abs_one or x
                        x = x - bar_abs_pos
                ...
                ScrollThumbFrame.MouseButton1Down:connect(function(x, y)
                    ...
                    drag_con = MouseDrag.MouseMoved:connect(function(x, y)
                        ...
                        local bar_drag =
                            ScrollBarFrame.AbsoluteSize.y -
                                ScrollThumbFrame.AbsoluteSize.y
                        local bar_abs_one = bar_abs_pos + bar_drag
                        y = y - mouse_offset
                        y =
                            y < bar_abs_pos and bar_abs_pos or y > bar_abs_one and
                                bar_abs_one or y
                        y = y - bar_abs_pos
            ...
            function Class:Destroy()
                ScrollFrame:Destroy()
                MouseDrag:Destroy()
                for k in pairs(Class) do Class[k] = nil end
    ...
    local SettingsRemote = explorerPanel.Parent:WaitForChild("SettingsPanel")
                               :WaitForChild("GetSetting")
    local GetApiRemote = explorerPanel.Parent:WaitForChild("PropertiesFrame")
                             :WaitForChild("GetApi")
    local GetAwaitRemote = explorerPanel.Parent:WaitForChild("PropertiesFrame")
                               :WaitForChild("GetAwaiting")
    local bindSetAwaiting = explorerPanel.Parent:WaitForChild("PropertiesFrame")
                                :WaitForChild("SetAwaiting")
    ...
    function CreateFunctionCallerMenu(choices, currentChoice, readOnly, onClick)
        ...
        local function showMenu()
            ...
            for i, name in pairs(choices) do
                local option = CreateRightClickMenuItem(
                                   name.ReturnType .. " " .. name.Name ..
                                       GetParameters(name),
                                   function() choice(name) end, 2)
                option.Size = UDim2.new(1, 0, 0, 20)
                option.Position = UDim2.new(0, 0, 0, (i - 1) * DropDown.Height)
                option.ZIndex = menu.ZIndex
                option.Parent = menu
    ...
    function CreateInsertObject()
        ...
        if currentRightClickMenu and CurrentInsertObjectWindow.Visible then
            CurrentInsertObjectWindow.Position = UDim2.new(0,
                                                           currentRightClickMenu.Position
                                                               .X.Offset -
                                                               currentRightClickMenu.Size
                                                                   .X.Offset - 2,
                                                           0, 0)
        end
    ...
    function CreateFunctionCaller()
        ...
        CurrentFunctionCallerWindow = CreateFunctionCallerMenu(GetFunctions(),
                                                               "", false,
                                                               function(option)
            CurrentFunctionCallerWindow:Destroy()
            CurrentFunctionCallerWindow = nil
            ...
            print(option.Name ..
                      " selected to be called. Function caller being added soon, please wait!")
            -- CallFunction()
            DestroyRightClick()
        end)
        if currentRightClickMenu and CurrentFunctionCallerWindow then
            CurrentFunctionCallerWindow.Position = UDim2.new(0,
                                                             currentRightClickMenu.Position
                                                                 .X.Offset -
                                                                 currentRightClickMenu.Size
                                                                     .X.Offset *
    ...
    function CreateRightClickMenuItem(text, onClick, insObj)
        ...
        button.MouseEnter:connect(function()
            ...
            if not insObj and CurrentInsertObjectWindow then
                if CurrentInsertObjectWindow.Visible == false and button.Text ==
                    "Insert Object" then
                    CreateInsertObject()
            ...
            if not insObj then
                if CurrentFunctionCallerWindow and button.Text ~=
                    "Call Function" then
                    CurrentFunctionCallerWindow:Destroy()
                    CurrentFunctionCallerWindow = nil
    ...
    function checkMouseInGui(gui)
        ...
        if plrMouse.X >= guiPosition.x and plrMouse.X <= guiPosition.x +
            guiSize.x and plrMouse.Y >= guiPosition.y and plrMouse.Y <=
    ...
    local clipboard = {}
    local function delete(o) o.Parent = nil end
    ...
    function filteringWorkspace()
        if explorerFilter.Text ~= "" and explorerFilter.Text ~=
            "Filter Workspace" then return true end
        return false
    end
    ...
    do
        local function r(t)
            for i = 1, #t do
                if not filteringWorkspace() or scanName(t[i].Object) then
                    ...
                    local w =
                        (t[i].Depth) * (2 + ENTRY_PADDING + GUI_SIZE) + 2 +
                            ENTRY_SIZE + 4 + getTextWidth(t[i].Object.Name) + 4
        ...
        function rawUpdateSize()
            ...
            scrollBarH:Update()
            local visible = scrollBarH:CanScrollDown() or
                                scrollBarH:CanScrollUp()
            scrollBarH.GUI.Visible = visible

            listFrame.Size = UDim2.new(1, -GUI_SIZE, 1, -GUI_SIZE *
                                           (visible and 1 or 0) - HEADER_SIZE)

            scrollBar.VisibleSpace = math.ceil(
                                         listFrame.AbsoluteSize.y / ENTRY_BOUND)
            scrollBar.GUI.Size = UDim2.new(0, GUI_SIZE, 1, -GUI_SIZE *
                                               (visible and 1 or 0) -
                                               HEADER_SIZE)
        ...
        function rawUpdateList()
            ...
            if DexStorageEnabled then r(NodeLookup[DexStorage]) end
            if NilStorageEnabled then r(NodeLookup[NilStorage]) end
            rawUpdateSize()
            updateActions()
        end
    ...
    do
        ...
        local SelectionSet = {}
        local Updates = true
        Selection = {Selected = SelectionSet, List = SelectionList}
        ...
        function Selection:StopUpdates() Updates = false end
        ...
        function Selection:Remove(object, noupdate)
            if SelectionSet[object] then
                ...
                if node then
                    ...
                    if not noupdate then scrollBar:Update() end
                    bindSelectionChanged:Fire()
                    updateActions()
                end
            end
        ...
        function Selection:Get()
            local list = {}
            for i = 1, #SelectionList do list[i] = SelectionList[i] end
            return list
        end

        bindSetSelection.OnInvoke = function(...) Selection:Set(...) end

        bindGetSelection.OnInvoke = function() return Selection:Get() end
    end
    ...
    function CreateTableCaution(title, msg)
        ...
        for i, v in pairs(msg) do
            ...
            newResult.Position = UDim2.new(0, 0, 0,
                                           #TableList:GetChildren() * 20)
            newResult.Parent = TableList
            TableList.CanvasSize = UDim2.new(0, 0, 0,
                                             #TableList:GetChildren() * 20)
    ...
    function PromptRemoteCaller(inst)
        ...
        newArgument.Type.MouseButton1Down:connect(function()
            createDDown(newArgument.Type,
                        function(choice)
                newArgument.Type.Text = choice
            end, "Script", "Number", "String", "Color3", "Vector3", "Vector2",
                        "UDim2", "NumberRange")
        end)
                    ...
                    if displayValues then
                        spawn(function()
                            ...
                            if myResults then
                                ...
                                CreateCaution("Remote Caller",
                                              "This remote did not return anything.")
                            end
                        end)
                    else
                        spawn(function()
        ...
        CurrentRemoteWindow.MainWindow.Add.MouseButton1Up:connect(function()
            if CurrentRemoteWindow then
                local newArgument = ArgumentTemplate:Clone()
                newArgument.Position = UDim2.new(0, 0, 0,
                                                 #ArgumentList:GetChildren() *
                                                     20)
                newArgument.Parent = ArgumentList
                ArgumentList.CanvasSize = UDim2.new(0, 0, 0,
                                                    #ArgumentList:GetChildren() *
                                                        20)
                newArgument.Visible = true
                newArgument.Type.MouseButton1Down:connect(function()
        ...
        CurrentRemoteWindow.MainWindow.Subtract.MouseButton1Up:connect(
            function()
                if CurrentRemoteWindow then
        ...
        CurrentRemoteWindow.MainWindow.DisplayReturned.MouseButton1Up:connect(
            function()
                if displayValues then
                    displayValues = false
                    CurrentRemoteWindow.MainWindow.DisplayReturned.enabled
                        .Visible = false
                else
                    displayValues = true
                    CurrentRemoteWindow.MainWindow.DisplayReturned.enabled
    ...
    function PromptSaveInstance(inst)
        ...
        CurrentSaveInstanceWindow.MainWindow.Save.MouseButton1Up:connect(
            function()
                if readfile and getelysianpath then
                    if readfile(getelysianpath() .. filename.Text .. ".rbxmx") then
                        if not overwriteCaution then
                            ...
                            newCaution.MainWindow.Desc.Text = "The file, " ..
                                                                  filename.Text ..
                                                                  ".rbxmx, already exists. Overwrite?"
                            newCaution.Parent = explorerPanel.Parent
                            newCaution.Visible = true
                            newCaution.MainWindow.Yes.MouseButton1Up:connect(
                                function()
                                    ypcall(function()
                                        SaveInstance(inst,
                                                     filename.Text .. ".rbxmx",
                            ...
                            newCaution.MainWindow.No.MouseButton1Up:connect(
                                function()
                                    overwriteCaution = false
                                    newCaution:Destroy()
                                end)
                        ...
                        if CurrentSaveInstanceWindow then
                            ...
                            if explorerPanel.Parent:FindFirstChild(
                                "SaveInstanceOverwriteCaution") then
                                explorerPanel.Parent
                                    .SaveInstanceOverwriteCaution:Destroy()
                            end
                        end
                    end
                else
        ...
        CurrentSaveInstanceWindow.MainWindow.Cancel.MouseButton1Up:connect(
            function()
                if CurrentSaveInstanceWindow then
                    CurrentSaveInstanceWindow:Destroy()
                    CurrentSaveInstanceWindow = nil
    ...
    function rightClickMenu(sObj)
        ...
        currentRightClickMenu = CreateRightClickMenu({
            ...
            "Ungroup", "Select Children", "Teleport To", "Insert Part",
            "Insert Object", "View Script", "Save Instance", "Call Function",
            "Call Remote"
            ...
            if option == "Cut" then
                ...
                for i = 1, #cut do pcall(delete, cut[i]) end
                updateActions()
            ...
            elseif option == "Duplicate" then
                ...
                for i = 1, #list do
                    list[i]:Clone().Parent =
                        Selection.List[1].Parent or workspace
                end
            elseif option == "Delete" then
                if not Option.Modifiable then return end
                local list = Selection:Get()
                for i = 1, #list do pcall(delete, list[i]) end
                Selection:Set({})
            elseif option == "Group" then
                ...
                for i = 1, #list do list[i].Parent = newModel end
                Selection:Set({})
            ...
            elseif option == "Call Remote" then
                ...
                local list = Selection:Get()
                for i = 1, #list do
                    if list[i]:IsA("RemoteFunction") or
                        list[i]:IsA("RemoteEvent") then
        ...
        if currentRightClickMenu.AbsolutePosition.X +
            currentRightClickMenu.AbsoluteSize.X >
            explorerPanel.AbsolutePosition.X + explorerPanel.AbsoluteSize.X then
            currentRightClickMenu.Position = UDim2.new(0,
                                                       explorerPanel.AbsolutePosition
                                                           .X +
                                                           explorerPanel.AbsoluteSize
                                                               .X -
                                                           currentRightClickMenu.AbsoluteSize
                                                               .X, 0, mouse.Y)
        end
    end
    ...
    do
        ...
        local function dragReparent(object, dragGhost, clickPos, ghostOffset)
            ...
            conDrag = mouseDrag.MouseMoved:connect(function(x, y)
                ...
                if dragged then
                    ...
                    if pos.x >= 0 and pos.x <= size.x and pos.y >= 0 and pos.y <=
                        size.y + ENTRY_SIZE * 2 then
                        local i = math.ceil(pos.y / ENTRY_BOUND - 2)
                        local node = TreeList[i + scrollBar.ScrollIndex]
                        if node and node.Object ~= object and
                            not object:IsAncestorOf(node.Object) then
                            parentIndex = i
                            local entry = listEntries[i]
                            if entry then
                                parentHighlight.Visible = true
                                parentHighlight.Position = UDim2.new(0, 1, 0,
                                                                     entry.AbsolutePosition
                                                                         .y -
                                                                         listFrame.AbsolutePosition
                                                                             .y)
                                parentHighlight.Size =
                                    UDim2.new(0, size.x - 4, 0,
                                              entry.AbsoluteSize.y)
                            end
                        end
                    end

                    dragGhost.Position =
                        UDim2.new(0, dragPos.x + ghostOffset.x, 0,
                                  dragPos.y + ghostOffset.y)
                elseif (clickPos - dragPos).magnitude > 8 then
                    dragged = true
                    SetZIndex(dragGhost, 9)
                    dragGhost.IndentFrame.Transparency = 0.25
                    dragGhost.IndentFrame.EntryText.TextColor3 =
                        GuiColor.TextSelected
                    dragGhost.Position =
                        UDim2.new(0, dragPos.x + ghostOffset.x, 0,
                                  dragPos.y + ghostOffset.y)
            ...
            conUp = mouseDrag.MouseButton1Up:connect(function()
                ...
                if dragged then
                    if parentIndex then
                        local parentNode =
                            TreeList[parentIndex + scrollBar.ScrollIndex]
                        if parentNode then
        ...
        local entryTemplate = Create('ImageButton', {
            ...
            Create('Frame', {
                ...
                Create(Icon(nil, 0), {
                    Name = "ExplorerIcon",
                    Position = UDim2.new(0, 2 + ENTRY_PADDING, 0.5,
                                         -GUI_SIZE / 2),
                    Size = UDim2.new(0, GUI_SIZE, 0, GUI_SIZE)
                }),
                Create('TextLabel', {
        ...
        function scrollBar.UpdateCallback(self)
            for i = 1, self.VisibleSpace do
                ...
                if node then
                        ...
                        entry.MouseButton1Down:connect(function(x, y)
                            ...
                            if HoldingShift and not filteringWorkspace() then
                                if lastSelectedNode then
                                    if i + self.ScrollIndex - lastSelectedNode >
                                        0 then
                                        Selection:StopUpdates()
                                        for i2 = 1, i + self.ScrollIndex -
                                            lastSelectedNode do
                                            local newNode =
                                                TreeList[lastSelectedNode + i2]
                                            if newNode then
                                        ...
                                        Selection:StopUpdates()
                                        for i2 = i + self.ScrollIndex -
                                            lastSelectedNode, 1 do
                                            local newNode =
                                                TreeList[lastSelectedNode + i2]
                                            if newNode then
                                                Selection:Add(newNode.Object)
                            ...
                            if Option.Modifiable then
                                ...
                                dragReparent(node.Object, entry:Clone(), pos,
                                             entry.AbsolutePosition - pos)
                            elseif Option.Selectable then
                                ...
                                dragSelect(i + self.ScrollIndex, true,
                                           'MouseButton1Up')
                            end
                        end)
                    ...
                    Icon(entry.IndentFrame.ExplorerIcon,
                         ExplorerIndex[object.ClassName] or 0)
                    ...
                    nameConnLookup[entry] =
                        node.Object.Changed:connect(function(p)
                            if p == 'Name' then
                                text.Text = object.Name
                            end
                        end)
                    ...
                    text.TextColor3 =
                        GuiColor[node.Selected and 'TextSelected' or 'Text']
        ...
        Connect(listFrame.Changed,
                function(p)
            if p == 'AbsoluteSize' then rawUpdateSize() end
        end)
        ...
        explorerPanel.MouseWheelForward:connect(function()
            if scrollBar.VisibleSpace - 1 > wheelAmount then
                ...
                scrollBar:ScrollTo(scrollBar.ScrollIndex -
    ...
    local function check(object) return object.AncestryChanged end
    ...
    local function buildDexStorage()
        ...
        if success and localDexStorage then
            for i, v in pairs(localDexStorage:GetChildren()) do
                ypcall(function() v.Parent = DexStorageMain end)
            end
        end
    ...
    function updateDexStorageListeners()
        for i, v in pairs(dexStorageListeners) do v:Disconnect() end
        dexStorageListeners = {}
        for i, v in pairs(DexStorageMain:GetChildren()) do
            pcall(function()
    ...
    do
        ...
        local function get(o) return o:GetChildren() end
        ...
        r(workspace.Parent)
        if DexStorageEnabled then r(DexStorage) end
        if NilStorageEnabled then r(NilStorage) end
    ...
    do
        ...
        local function makeButton(icon, over, name, vis, cond)
            ...
            local button = Create(Icon('ImageButton', icon), {
                ...
                Position = UDim2.new(1, -(GUI_SIZE + 2) * currentActions + 2,
                                     0.25, -GUI_SIZE / 2),
                Size = UDim2.new(0, GUI_SIZE, 0, GUI_SIZE),
                Parent = headerFrame
            })
        ...
        makeButton(ACTION_EDITQUICKACCESS, ACTION_EDITQUICKACCESS, "Options",
                   true, function() return true end).MouseButton1Click:connect(
            function() end)

        -- DELETE
        makeButton(ACTION_DELETE, ACTION_DELETE_OVER, "Delete", true,
                   function() return #Selection:Get() > 0 end).MouseButton1Click:connect(
            function()
                if not Option.Modifiable then return end
                local list = Selection:Get()
                for i = 1, #list do pcall(delete, list[i]) end
        ...
        -- COPY
        makeButton(ACTION_COPY, ACTION_COPY_OVER, "Copy", true,
                   function() return #Selection:Get() > 0 end).MouseButton1Click:connect(
            function()
                if not Option.Modifiable then return end
                clipboard = {}
        ...
        -- CUT
        makeButton(ACTION_CUT, ACTION_CUT_OVER, "Cut", true,
                   function() return #Selection:Get() > 0 end).MouseButton1Click:connect(
            function()
                if not Option.Modifiable then return end
                clipboard = {}
        ...
        -- FREEZE
        makeButton(ACTION_FREEZE, ACTION_FREEZE, "Freeze", true,
                   function() return true end)

        -- ADD/REMOVE STARRED
        makeButton(ACTION_ADDSTAR, ACTION_ADDSTAR_OVER, "Star", true,
                   function() return #Selection:Get() > 0 end)

        -- STARRED
        makeButton(ACTION_STARRED, ACTION_STARRED, "Starred", true,
                   function() return true end)
    ...
    function SelectionVar() return Selection end

    Input.InputBegan:connect(function(key)
        if key.KeyCode == Enum.KeyCode.LeftControl then
            HoldingCtrl = true
        end
        if key.KeyCode == Enum.KeyCode.LeftShift then HoldingShift = true end
    end)
    ...
    explorerFilter.Changed:connect(function(prop)
        if prop == "Text" then rawUpdateList() end
    end)

    CurrentInsertObjectWindow = CreateInsertObjectMenu(GetClasses(), "", false,
                                                       function(option)
        CurrentInsertObjectWindow.Visible = false
        local list = SelectionVar():Get()
        for i = 1, #list do
...
--]]
    ...
    local print = function(s) print(tostring(s)) end
    ...
    function splitStringIntoChunks(jsonStr)
        ...
        for i = 1, math.ceil(string.len(jsonStr) / maxChunkSize) do
            local str =
                jsonStr:sub((i - 1) * maxChunkSize + 1, i * maxChunkSize)
            table.insert(t, str)
        end
        return t
    end
...
--]]
        ...
        local function isEnum(name) return Enums[name] ~= nil end
...
--]]
    ...
    local SettingsRemote = Gui:WaitForChild("SettingsPanel"):WaitForChild(
                               "GetSetting")
    ...
    function searchingProperties()
        if propertiesSearch.Text ~= "" and propertiesSearch.Text ~=
            "Search Properties" then return true end
        return false
    end
    ...
    local function Round(number, decimalPlaces)
        return tonumber(string.format("%." .. (decimalPlaces or 0) .. "f",
                                      number))
    end
    ...
    local function ToString(value, type)
        ...
        elseif type == "UDim2" then
            ...
            return string.format("{%d, %d}, {%d, %d}", xScale, xOffset, yScale,
                                 yOffset)
        else
            return tostring(value)
        end
    ...
    -- Spritesheet
    local Sprite = {Width = 13, Height = 13}
    ...
    local Images = {
        "unchecked", "checked", "unchecked_over", "checked_over",
        "unchecked_disabled", "checked_disabled"
    }
    ...
    local function SpritePosition(spriteName)
        ...
        for i, v in pairs(Images) do
            if (v == spriteName) then return {x, y} end
            x = x + Sprite.Height
    ...
    local function CreateTextButton(readOnly, onClick)
        ...
        if readOnly then
            ...
            button.TextColor3 = Row.TextColor
            button.MouseButton1Click:connect(function() onClick() end)
        end
        return button
    end
    ...
    local function CreateDropDownItem(text, onClick)
        ...
        button.MouseButton1Click:connect(function() onClick(text) end)
        return button
    end
    ...
    local function CreateDropDown(choices, currentChoice, readOnly, onClick)
        ...
        button.BackgroundTransparency = 1
        button.TextColor3 = Row.TextColor
        if readOnly then button.TextColor3 = Row.TextLockedColor end
        button.Text = currentChoice
        button.Size = UDim2.new(1, -2 * Styles.Margin, 1, 0)
        button.Position = UDim2.new(0, Styles.Margin, 0, 0)
        button.Parent = frame
        ...
        local function showArrow(color)
            ...
            arrow.Position = UDim2.new(1, -graphicSize * 2, 0.5,
                                       -graphicSize / 2)
            arrow.Parent = frame
        end
        ...
        local function showMenu()
            ...
            local parentFrameHeight = menu.Parent.Parent.Parent.Parent.Size.Y
                                          .Offset
            local rowHeight = menu.Parent.Parent.Parent.Position.Y.Offset
            if (rowHeight + menu.Size.Y.Offset) >
                math.max(parentFrameHeight, PropertiesFrame.AbsoluteSize.y) then
                menu.Position = UDim2.new(0, margin, 0, -1 *
                                              (#choices * DropDown.Height) -
                                              margin)
            end
            ...
            for i, name in pairs(choices) do
                local option = CreateDropDownItem(name,
                                                  function()
                    choice(name)
                end)
    ...
    local function CreateBrickColor(readOnly, onClick)
        ...
        colorPalette.Size = UDim2.new(1, -2 * BrickColors.OuterBorder, 1,
                                      -2 * BrickColors.OuterBorder)
        colorPalette.BorderSizePixel = BrickColors.BorderSizePixel
        colorPalette.BorderColor3 = BrickColors.BorderColor
        colorPalette.Position = UDim2.new(0, BrickColors.OuterBorder, 0,
                                          BrickColors.OuterBorder + Row.Height)
        ...
        local function show() colorPalette.Visible = true end

        local function hide() colorPalette.Visible = false end
        ...
        colorBox.Size =
            UDim2.new(0, BrickColors.BoxSize, 0, BrickColors.BoxSize)
        colorBox.Text = ""
        colorBox.MouseButton1Click:connect(function()
            if not readOnly then toggle() end
        end)

        if readOnly then colorBox.AutoButtonColor = false end
    ...
    function CreateCheckbox(value, readOnly, onClick)
        ...
        spritesheetImage.Size = UDim2.new(0, Spritesheet.Width, 0,
                                          Spritesheet.Height)
        ...
        local function updateSprite()
            local spriteName =
                GetCheckboxImageName(checked, readOnly, mouseover)
            local spritePosition = SpritePosition(spriteName)
            spritesheetImage.Position = UDim2.new(0, -1 * spritePosition[1], 0,
                                                  -1 * spritePosition[2])
        end
    ...
    Controls["default"] = function(object, propertyData, readOnly)
        ...
        object.Changed:connect(function(property)
            if (property == propertyName) then update() end
        end)
    ...
    Controls["bool"] = function(object, propertyData, readOnly)
        ...
        local checkbox, setValue = CreateCheckbox(checked, readOnly, function(
            value) Set(object, propertyData, not checked) end)
        ...
        if object:IsA("BoolValue") then
            object.Changed:connect(function(val) update() end)
        end
    ...
    Controls["BrickColor"] = function(object, propertyData, readOnly)
        ...
        local frame, label, brickColorBox =
            CreateBrickColor(readOnly, function(brickColor)
    ...
    Controls["Enum"] = function(object, propertyData, readOnly)
        ...
        local dropdown, propertyLabel = CreateDropDown(enumNames, enumName,
    ...
    function CanEditProperty(object, propertyData)
        ...
        for _, name in pairs(tags) do
            if name == "readonly" then return false end
        end
    ...
    function CreateRow(object, propertyData, isAlternateRow)
        ...
        if (isAlternateRow) then backColor = Row.BackgroundColorAlternate end
    ...
    function checkForDupe(prop, props)
        for i, v in pairs(props) do
            if v.propertyData.Name == prop.Name and v.propertyData.ValueType ==
                prop.ValueType then return true end
        end
        return false
    end
                ...
                for i, v in pairs(RbxApi.GetProperties(nextObj.className)) do
                    local suc, err = pcall(function()
                        if not (PropertyIsHidden(v)) and
                            ...
                            if string.find(string.lower(v.Name),
                                           string.lower(propertiesSearch.Text)) or
    ...
    function SetZIndexOnChanged(object)
        return object.Changed:connect(function(p)
            if p == "ZIndex" then SetZIndex(object, object.ZIndex) end
        end)
    end
    function Create(ty, data)
        local obj
    ...
    do
        ...
        function ScrollBar(horizontal)
            ...
            local ScrollFrame = Create('Frame', {
                Name = "ScrollFrame",
                Position = horizontal and UDim2.new(0, 0, 1, -ScrollBarWidth) or
                    UDim2.new(1, -ScrollBarWidth, 0, 0),
                ...
                Create('ImageButton', {
                    ...
                    Position = horizontal and
                        UDim2.new(1, -ScrollBarWidth, 0, 0) or
                        UDim2.new(0, 0, 1, -ScrollBarWidth),
                ...
                Create('ImageButton', {
                    Name = "ScrollBar",
                    Size = horizontal and
                        UDim2.new(1, -ScrollBarWidth * 2, 1, 0) or
                        UDim2.new(1, 0, 1, -ScrollBarWidth * 2),
                    Position = horizontal and UDim2.new(0, ScrollBarWidth, 0, 0) or
                        UDim2.new(0, 0, 0, ScrollBarWidth),
                    AutoButtonColor = false,
                    BackgroundColor3 = Color3.new(0.94902, 0.94902, 0.94902),
                    BorderColor3 = ScrollStyles.Border,
                    -- BorderSizePixel = 0;
            ...
            if horizontal then
                function UpdateScrollThumb()
                    ...
                    if ScrollThumbFrame.AbsoluteSize.x < ScrollBarWidth then
                        ScrollThumbFrame.Size =
                            UDim2.new(0, ScrollBarWidth, 0, ScrollBarWidth)
                    end
                    local barSize = ScrollBarFrame.AbsoluteSize.x
                    ScrollThumbFrame.Position = UDim2.new(
                                                    Class:GetScrollPercent() *
    ...
    do
        ...
        function scrollBar.UpdateCallback(self)
            ...
            ContentFrame.Position = UDim2.new(ContentFrame.Position.X.Scale,
                                              ContentFrame.Position.X.Offset, 0,
    ...
    propertiesSearch.Changed:connect(function(prop)
        if prop == "Text" then showProperties(GetSelection()) end
    end)

    bindGetApi.OnInvoke = function() return RbxApi end

    bindGetAwait.OnInvoke = function() return AwaitingObjectValue end
end)
spawn(function()
    ...
    function AddZeros(num, reach)
        ...
        while #toConvert < reach do toConvert = " " .. toConvert end
        return toConvert
    end
    ...
    function buildScript(source, xOff, yOff, override)
        ...
        if currentSource ~= source then currentSource = source end
	...
	--]]
        ...
        for i = 1, #grid do
            for j = 1, #grid[i] do
                if i <= lineSpan then
                    ...
                    grid[i][j].BackgroundColor3 =
                        Color3.new(163 / 255, 162 / 255, 165 / 255)
                    -- grid[i][j].Font = Enum.Font.SourceSansBold
                elseif i == lineSpan + 1 then
                    grid[i][j].Text = ""
                    grid[i][j].BackgroundTransparency = 0
                    grid[i][j].BackgroundColor3 =
                        Color3.new(200 / 255, 200 / 255, 200 / 255)
        ...
        while true do
            ...
            while string.len(entry) > 0 do
                ...
                if delayance == 0 then
                    grid[currentColumn][currentRow].Text =
                        string.sub(entry, 1, 1)
                end
                ...
                if not inString then
                    for i, v in pairs(syntaxHighlightList) do
                        if string.sub(entry, 1, string.len(v["Keyword"])) ==
                            v["Keyword"] then
                            if v["Independent"] then
                                local outCheck = string.len(v["Keyword"]) + 1
                                local outEntry =
                                    string.sub(entry, outCheck, outCheck)
                ...
                if string.sub(entry, 1, 1) == "\"" and
                    string.match(entry, "\".+\"") then
                    inString = true
                ...
                if colorTime > 0 then
                    ...
                    grid[currentColumn][currentRow].TextColor3 = Color3.new(0,
                                                                            0, 0)
                    inString = false
                end
    ...
    function scrollBar.UpdateCallback(self)
        ...
        buildScript(currentSource, math.floor(scrollBarH.ScrollIndex / 8),
                    math.floor(scrollBar.ScrollIndex / 16))
    end
    ...
    function getLongestEntry(tab)
        ...
        for i, v in pairs(tab) do
            if string.len(v) > longest then longest = string.len(v) end
        end
        return longest
    end
                ...
                if v == newTab then
                    ...
                    if editingIndex == i then
                        ...
                        if editingIndex > 0 then
                            buildScript(memoryScripts[#memoryScripts].Source, 0,
                                        0, true)
                        else
        ...
        for i, v in pairs(scriptBar:GetChildren()) do
            ...
            elseif v.Position.X.Offset >= 0 then
                ...
                if entryCount == 5 then
                    ...
                    for i, v in pairs(
                                    scriptBarRight["Arrow Graphic"]:GetChildren()) do
                        v.BackgroundTransparency = 0
                    end
                end
            end
    ...
    openEvent.Event:connect(function(...)
        top.Visible = true
        local args = {...}
        if #args > 0 then openScript(args[1]) end
    end)
    ...
    closeButton.MouseButton1Click:connect(function() top.Visible = false end)
